...
import { deleteCoStrictCredentials } from '../../costrict/provider/credentials.js';
import { clearModelCache } from '../../costrict/provider/models.js';
...
export async function performLogout({ clearOnboarding = false }): Promise<void> {
  ...
  // Clear CoStrict credentials and model cache
...
export async function call(): Promise<React.ReactNode> {
  ...
  const message = <Text>Successfully logged out from your CoStrict account.</Text>;
